<template>
    <div class="bg-white">
        ...
        <header class="relative bg-white">
            <p
                class="flex h-10 items-center justify-center bg-gradient-to-r from-secondary to-primary px-4 text-sm font-medium text-white sm:px-6 lg:px-8">
                Site Ecommerce</p>
                            ...
                            <div class="flex h-full space-x-8">
                                <Popover v-for="category in navigation.categories" :key="category.name" class="flex"
                                    ...
                                    <div class="relative flex">
                                        <PopoverButton
                                            :class="[open ? 'border-primary ' : 'border-transparent text-gray-700 hover:text-gray-800', 'relative z-10 -mb-px flex items-center border-b-2 pt-px text-sm font-medium transition-colors duration-200 ease-out']">
